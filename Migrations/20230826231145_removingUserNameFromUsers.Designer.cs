...
namespace dpdPublicQuizAPI.Migrations
{
    ...
    [Migration("20230826231145_removingUserNameFromUsers")]
    partial class removingUserNameFromUsers
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("dpdPublicQuizAPI.Models.Quiz", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("dpdPublicQuizAPI.Models.Quiz", b =>
                {
                    b.HasOne("dpdPublicQuizAPI.Models.ClassRoom", null)
                        .WithMany("Quizzes")
